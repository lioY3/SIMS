...
<body>
	...
	<div style="text-align: center;">
		<div class="layui-inline">
			<table id="grade-info" lay-filter="SC"></table>
		</div>
	</div>
	<!-------------------------------------------------------------数据表格--------------------------------------------------------------->
	...
	<div class="layui-row" id="addopen_div" style="display: none;">
		<form id="add_form" class="layui-form" action="" style="margin-top: 20px; align: center;">
			<input type="hidden" name="action" id="action" value="AddScore">
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<input type="text" name="grade" id="form_grade" class="layui-input" autocomplete="off">
				</div>
			</div>
	 ...
	 layui.use(['table', 'layer', 'form', 'laypage'], function () {
	     ...
	     table.on('toolbar(SC)', function (obj) {
	         ...
	         case 'add':
	             ...
	             // 调用打开弹层的工具方法
	             open_form("#open_div", data, '增加成绩', '380px', '550px');
	             break;
	         }
	     });
	         ...
	         case 'del':
	             layer.confirm('真的删除该行么', function (index) {
	                 ...
	                 $.ajax({
	                     ...
	                     url: "${pageContext.request.contextPath}/ScoreServlet?method=DeleteScore&sno=" + sid + "&cno=" + cid, //提交到的url
